...
export interface CheckboxInputProps {
    ...
    onSelect: (item: CheckboxInputItem, event?: React.SyntheticEvent<HTMLInputElement>) => void;
    isSelected: boolean;
    isDisabled?: boolean;
}

function Checkbox({ isSelected, item, onSelect, isDisabled }: CheckboxInputProps) {
    const {
